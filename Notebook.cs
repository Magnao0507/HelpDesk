namespace HelpDeskAPI
{
    public class Notebook
    {
        ...
        public static Notebook DeCsv(string linha)
        {
            ...
            return new Notebook { Data = c[0], Usuario = c[1], ModeloFinal = c[2], NomeMaquina = c[3], Processador = c[4], RAM = c[5], TotalDisco = c[6], PercentualUso = c[7], NumeroSerie = c[8], SO = c[9] };
        }
    }
}